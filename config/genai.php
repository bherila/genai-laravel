    ...
    */
    ...
    'mcp' => [
        ...
        'limits' => [
            ...
            'max_claim_json_bytes' => (int) env('GENAI_MCP_MAX_CLAIM_BYTES', 3145728),
            'max_input_text_chars' => (int) env('GENAI_MCP_MAX_INPUT_TEXT_CHARS', 500000),
        ...
        'rest' => [
            ...
            // Checked before JSON decoding; leaves headroom over max_completion_bytes for the envelope.
            'max_body_bytes' => (int) env('GENAI_MCP_REST_MAX_BODY_BYTES', 1114112),
        ],
        'server' => [
            ...
            'max_response_body_bytes' => (int) env('GENAI_MCP_MAX_RESPONSE_BODY_BYTES', 1048576),
