 ...
 * @method static int|null maxInlineBlocksPerMessage(string $mimeType)
 * @method static int|null maxRequestBytes()
 ...
 * @method static array{role: string, content: array<int, ContentBlock>} extractAssistantMessage(array<string, mixed> $response)
